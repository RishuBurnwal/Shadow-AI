...
export class AssistantView extends LitElement {
    ...
    connectedCallback() {
        ...
        this._screenAnalysisState = event => {
            this.isAnalyzing = event.detail;
        };
        window.addEventListener('screen-analysis-state', this._screenAnalysisState);
    ...
    disconnectedCallback() {
        ...
        window.removeEventListener('screen-analysis-state', this._screenAnalysisState);
    ...
    async handleScreenAnswer() {
        if (!this.isAnalyzing) await window.captureManualScreenshot?.();
    }
    ...
    updated(changedProperties) {
        if (changedProperties.has('screenAnalysisMode') || changedProperties.has('screenshotInterval')) this._syncScreenCountdown();
        ...
        return html`
            ...
            <div class="screen-analysis-bar">
                ...
                >
                    ...
                    <option value="off">Off · no screen sent</option>
