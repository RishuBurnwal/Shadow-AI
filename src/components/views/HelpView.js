...
export class HelpView extends LitElement {
    ...
    async _loadKeybinds() {
        try {
            const keybinds = await shadowAI.storage.getKeybinds();
            if (keybinds) {
            ...
            <div class="unified-page">
                <div class="unified-wrap">
                    ...
                    <section class="surface">
                        ...
                        <div class="link-row">
                            <button class="link-button" @click=${() => this._open('https://shadow-ai.com')}>Website</button>
                            <button class="link-button" @click=${() => this._open('https://github.com/RishuBurnwal/shadow-ai')}>GitHub</button>
                            <button class="link-button" @click=${() => this._open('https://www.linkedin.com/in/rishuburnwal/')}>LinkedIn</button>
                        </div>
                    </section>
