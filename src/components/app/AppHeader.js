...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await shadowAI.getVersion();
            const response = await fetch('https://raw.githubusercontent.com/sohzm/shadow-ai/refs/heads/master/package.json');
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Shadow AI',
            main: 'Shadow AI',
            customize: 'Customize',
            help: 'Help & Shortcuts',
        ...
        return titles[this.currentView] || 'Shadow AI';
    }
                        ...
                        this.currentView === 'assistant'
                            ? html`
                                  <button @click=${this.onHideToggleClick} class="button">
                                      Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${shadowAI.isMacOS ? 'Cmd' : 'Ctrl'}</span
