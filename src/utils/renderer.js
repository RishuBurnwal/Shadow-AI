...
let lastHeaderInteractive = null;
window.addEventListener('mousemove', event => {
    const headerInteractive = event.clientY <= 48;
    if (headerInteractive === lastHeaderInteractive) return;
    lastHeaderInteractive = headerInteractive;
    ipcRenderer.send('set-passthrough-header-region', headerInteractive);
});
